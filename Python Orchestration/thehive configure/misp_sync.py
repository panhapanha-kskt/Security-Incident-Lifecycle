...
def _extract_rule_id(case_data: dict) -> str:
    """Pulls rule_id from the case tags TheHiveCaseManager already attaches
    (f"rule:{rule_id}") instead of regexing the title. Also correctly
    handles correlation cases, whose tag looks like "rule:CORR:<name>"."""
